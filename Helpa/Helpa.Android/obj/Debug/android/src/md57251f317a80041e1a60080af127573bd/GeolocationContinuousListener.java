package md57251f317a80041e1a60080af127573bd;
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.2.0.0, Culture=neutral, PublicKeyToken=null", GeolocationContinuousListener.class, __md_methods);
	}
	...
	public GeolocationContinuousListener ()
	{
		...
		if (getClass () == GeolocationContinuousListener.class)
			mono.android.TypeManager.Activate ("Plugin.Geolocator.GeolocationContinuousListener, Plugin.Geolocator, Version=4.2.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
