...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Geolocator.GeolocationSingleListener, Plugin.Geolocator, Version=4.2.0.0, Culture=neutral, PublicKeyToken=null", GeolocationSingleListener.class, __md_methods);
	}
	...
	public GeolocationSingleListener ()
	{
		...
		if (getClass () == GeolocationSingleListener.class)
			mono.android.TypeManager.Activate ("Plugin.Geolocator.GeolocationSingleListener, Plugin.Geolocator, Version=4.2.0.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
